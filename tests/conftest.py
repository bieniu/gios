...
def stations() -> list[dict[str, Any]]:
    ...
    with Path.open("tests/fixtures/stations.json", encoding="utf-8") as file:
...
def station() -> list[dict[str, Any]]:
    ...
    with Path.open("tests/fixtures/station.json", encoding="utf-8") as file:
        return json.load(file)
...
def indexes() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/indexes.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_658() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_658.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_660() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_660.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_665() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_665.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_667() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_667.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_670() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_670.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_672() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_672.json", encoding="utf-8") as file:
        return json.load(file)
...
def sensor_14395() -> dict[str, Any]:
    ...
    with Path.open("tests/fixtures/sensor_14395.json", encoding="utf-8") as file:
        return json.load(file)
